...
!
! LinkedList_Class.f90 is part of the Spectral Element Libraries in Fortran (SELF).
! 
...
!> \file LinkedList_Class.f90
!! Contains the \ref LinkedList_Class module, and <BR>
!! defines the \ref Record and \ref LinkedList data-structures.


!> \defgroup LinkedList_Class LinkedList_Class
...
!!
!! <H3> Procedures </H3>
!!    See \ref LinkedList_Class for more information. The first column lists the "call-name" and the second
