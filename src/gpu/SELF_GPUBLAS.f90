...
subroutine self_blas_matrixop_1d(A,f,Af,opArows,opAcols,bcols,handle)
  ...
  end subroutine self_blas_matrixop_1d
  ...
  end subroutine self_blas_matrixop_dim1_2d
  ...
  end subroutine self_blas_matrixop_dim2_2d
  ...
  end subroutine self_blas_matrixop_dim1_3d
  ...
  subroutine self_blas_matrixop_dim2_3d(A,f,Af,beta,controldegree,targetdegree,nvars,nelems,handle)
    ...
    call c_f_pointer(f, f_p, [targetdegree+1,controldegree+1,controldegree+1,nelems,nvars])
    call c_f_pointer(Af,Af_p,[targetdegree+1,targetdegree+1,controldegree+1,nelems,nvars])
    ...
    do i = 0,targetdegree
      call hipblasCheck(hipblasgemvStridedBatched(handle, &
                                                   ...
                                                   m,n,alpha, &
                                                   A,lda,strideA, &
                                                   c_loc(f_p(1 + i,1,1,1,1)),incx,stridex,beta, &
                                                   c_loc(Af_p(1 + i,1,1,1,1)),incy,stridey,batchCount))
    end do

  end subroutine self_blas_matrixop_dim2_3d
  ...
  end subroutine self_blas_matrixop_dim3_3d
end module SELF_GPUBLAS