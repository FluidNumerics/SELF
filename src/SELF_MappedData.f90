...
#define __FUNC__ "JacobianWeight_MappedScalar1D"
  ...
  endsubroutine JacobianWeight_MappedScalar2D
  ...
  endsubroutine JacobianWeight_MappedScalar3D
  ...
  endsubroutine JacobianWeight_MappedVector2D
  ...
  endsubroutine JacobianWeight_MappedVector3D
