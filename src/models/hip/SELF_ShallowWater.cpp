...
__global__ void Source_ShallowWater_gpu(real *source, real *solution, real f, int N, int nVar){
...
extern "C"
{
  void Source_ShallowWater_gpu_wrapper(real **source, real **solution, real f, int N, int nVar, int nEl)
  {
    Source_ShallowWater_gpu<<<dim3(nVar,nEl,1), dim3(N+1,N+1,1), 0, 0>>>(*source, *solution, f, N, nVar);
  }
}
