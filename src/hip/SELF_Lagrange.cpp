...
// VectorDGSplitDivergence_2D //
__global__ void VectorDGSplitDivergence_2D_gpu(real *dgMatrix, real *dMatrix, real *bMatrix, real *qWeights, real *f, real *solution, real* velocity, real *bf, real *df, int N, int nVar){
...
extern "C"
{
  void VectorDGSplitDivergence_2D_gpu_wrapper(real **dgMatrix, real **dMatrix, real **bMatrix, real **qWeights, real **f, real **solution, real **velocity, real **bf, real **df, int N, int nVar, int nEl)
  {
	  VectorDGSplitDivergence_2D_gpu<<<dim3(nVar,nEl,1), dim3(N+1,N+1,1), 0, 0>>>(*dgMatrix, *dMatrix, *bMatrix, *qWeights, *f, *solution, *velocity, *bf, *df, N, nVar);
  } 
}
