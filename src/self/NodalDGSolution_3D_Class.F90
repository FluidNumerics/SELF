...
! ================================================================================================ !
  ...
  SUBROUTINE Write_Pipeline_File( nodalSolution, filename )
    ...
    ! Create groups 
    groupname = "/internal"
    CALL h5gcreate_f( file_id, TRIM(groupname), internal_group_id, error )
    IF( error /= 0 ) STOP
...
END SUBROUTINE Write_Pipeline_File
