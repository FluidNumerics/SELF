program test
  ...
  exit_code = vectorgridinterp_2d_gpu_constant()
  stop exit_code

contains
integer function vectorgridinterp_2d_gpu_constant() result(r)
  use SELF_Constants
  use SELF_Memory
  use SELF_Lagrange
  use SELF_Data
...
end function vectorgridinterp_2d_gpu_constant
end program test
