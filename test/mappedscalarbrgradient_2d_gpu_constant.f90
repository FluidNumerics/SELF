integer function mappedscalarbrgradient_2d_gpu_constant() result(r)
  ...
  do iel = 1,f % nElem
    do iside = 1,4
      ...
      if (e2 == 0)then
        do i = 0,f % interp % N
          f % extboundary % hostData(i,1,iside,iel) = f % boundary % hostdata(i,1,iside,iel) 
        end do
      end if
    end do
  end do
...
end function mappedscalarbrgradient_2d_gpu_constant
