...
tree and are the only two substitutions applied before the comparison, and the year
substitution replaces the four digits alone rather than the copyright marker
with them. Line
